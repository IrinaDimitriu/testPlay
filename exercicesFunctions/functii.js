...
let becauseSentence =
    "Eu invat, eu invat limba, deja invat si am invatat";
...
console.log('Conditia este: Găsiți cel mai mic număr din arrayul declarat în fisier1')
console.log(`Variabilă declarată este - ${arrayEx1}`)
console.log(`Rezultatul meu este -` + `\u001b[1;32m` + `'${gasesteNrCelMaiMic(arrayEx1)}'` + `\u001b[0m`)
